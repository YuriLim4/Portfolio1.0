...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="yuri.lim4@gmail.com";  // Your Mail
	$mail->Password="Your App Password"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("yuri.lim4@gmail.com", "Yuri Lima"); // (Your Mail) An email address that will receive the email with the output of the form

	$mail->IsHTML(true); // Set email format to HTML

	$mail->Subject = "(Yuri) New Contact Info";
	$mail->Body = $html;
